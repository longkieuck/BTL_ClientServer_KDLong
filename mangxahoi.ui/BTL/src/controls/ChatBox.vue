    ...
    <div class="chat-box" v-if="isShowChatBox">
        ...
        <div class="content-chat-box" id="scrollingChat">
          <div v-for="msg in listMessage" :key="msg.Id">
            <div
              v-if="msg.UserId != user.Id"
              class="friend-chat-without-avt"
            >
...
export default {
    ...
    computed:{
      ...mapState({
        ...
        isShowChatBox:(state) => state.common.isShowChatBox,
        userChat:(state) => state.common.userChat,
        chatBoxData:(state) => state.common.chatBoxData,
        listMessage:(state) => state.common.listMessage,
